...
protocol WSClientProtocol  {
    ...
    static func requestContent(method:Alamofire.Method, urlRequest: NSMutableURLRequest, parameters: GenericJSON?, cached:Bool?, encoding: ParameterEncoding) -> WSRequestTask
